...
namespace Snail.Logic
{
    ...
    internal class Created : IState
    {
        ...
        public int Current =>
            throw new InvalidOperationException(
                "It is not allowed to access Current before MoveNext() has been called.");
    ...
    internal class DownMovement : Movement
    {
        ...
        public DownMovement(int[][] array, int column, int row) : base(array, column, row) =>
    ...
    internal class LeftMovement : Movement
    {
        ...
        private bool IsAtTerminatingPosition() =>
            Array.Length % 2 == 0 && Column == _terminatingColumn && Row == _terminatingRow;
    }
